...
curl -u travis-arq-testing:aut0m4tASV71 --request POST --data '{"tag_name": "v1.0.1-curl","target_commitish": "master","name": "v1.0.2-curl","body": "Release of version 1.0.1","draft": false,"prerelease": false}' https://api.github.com/repos/nievesSopra/sauce-project/releases
